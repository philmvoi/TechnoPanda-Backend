...
export default {
    Query: {
        ...
        async allOrderOrderLines(root) {return sequelize.query(
            "SELECT order_line_id, ol.order_id, package_name, package_description, order_line_quantity, price FROM order_line ol JOIN order_ o ON ol.order_id = o.order_id JOIN package p ON ol.package_id = p.package_id ORDER BY order_line_id DESC",
            {raw: true, type: sequelize.QueryTypes.SELECT}
        )},   
    },
